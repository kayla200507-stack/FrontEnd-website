            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div>
                  ...
                  <input
                    type="email"
                    defaultValue="keisya@mahasiswa.edu"
                    className="w-full border border-slate-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition"
                  />
                </div>
                <div>
            ...
            <div className="p-8">
              ...
              <div className="space-y-4">
                {[
                  {
                    title: "Resume / CV",
                    desc: "Format PDF, max 5MB",
                    status: "Terunggah",
                  },
                  {
                    title: "Transkrip Nilai",
                    desc: "Semester 1 s.d terakhir. PDF max 5MB",
                    status: "Belum diunggah",
                  },
                  {
                    title: "Surat Rekomendasi",
                    desc: "Opsional. PDF max 5MB",
                    status: "Belum diunggah",
                  },
                ].map((doc, idx) => (
                  <div
                    key={idx}
                    className="flex flex-col md:flex-row md:items-center justify-between p-5 border border-slate-200 rounded-2xl hover:border-blue-200 transition bg-slate-50/50 gap-4"
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        {doc.status === "Terunggah" ? (
                          ...
                          <span className="inline-block text-xs font-medium text-slate-400 mt-1">
                            {doc.status}
                          </span>
                        )}
                      </div>
            ...
            <div className="p-8">
              ...
              <div className="divide-y divide-slate-100 border border-slate-200 rounded-2xl overflow-hidden">
                <div className="p-5 flex items-center justify-between bg-white hover:bg-slate-50 transition">
                  ...
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${pushNotif ? "translate-x-6" : "translate-x-1"}`}
                    />
                  </button>
                </div>
                ...
                <div className="p-5 flex items-center justify-between bg-white hover:bg-slate-50 transition">
                  <div>
                    ...
                    <p className="text-sm text-slate-500 mt-0.5">
                      Laporan aktivitas magang via email
                    </p>
                  </div>
                  <button
                  ...
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${emailReport ? "translate-x-6" : "translate-x-1"}`}
                    />
                  </button>
                </div>
                ...
                <div className="p-5 flex items-center justify-between bg-white hover:bg-slate-50 transition">
                  <div>
                    ...
                    <p className="text-sm text-slate-500 mt-0.5">
                      Pengingat tugas dan logbook harian
                    </p>
                  </div>
                  <button
                  ...
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${deadlineAlert ? "translate-x-6" : "translate-x-1"}`}
                    />
                  </button>
                </div>
              </div>
            ...
            <div className="p-8">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 mb-5 max-w-2xl">
                  Tambahkan lapisan keamanan ekstra ke akun Anda. Saat aktif,
                  Anda harus memasukkan kode unik yang dikirimkan ke perangkat
                  Anda setiap kali login.
                </p>
                <div className="flex items-center gap-4">
                  <button
